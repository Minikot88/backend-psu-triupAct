...
@Controller('api/educationlevels')
export class EducationlevelsController {
  ...
  // กำหนด endpoint: GET /educationlevels
  @Get()
  async getEducationlevels() {
    ...
    const res = await fetch('https://triup.tsri.or.th/service/api/educationlevels', {
    ...
    if (!res.ok) {
      ...
      return { 
        success: false, 
        error: `educationlevels fetch failed: ${res.status} ${res.statusText} ${text}` 
      };
    }
