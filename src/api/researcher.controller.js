...
export class ResearcherController {
  ...
  async getResearcher() {
    ...
    const res = await fetch('https://triup.tsri.or.th/service/api/users/researcher', {
    ...
    if (!res.ok) {
      ...
      return { 
        success: false, 
        error: `researcher fetch failed: ${res.status} ${res.statusText} ${text}` 
      };
    }
