...
export class AddressController {
  ...
  async getAddress() {
    ...
    const res = await fetch('https://triup.tsri.or.th/service/api/address/province', {
    ...
    if (!res.ok) {
      ...
      return { 
        success: false, 
        error: `address/province fetch failed: ${res.status} ${res.statusText} ${text}` 
      };
    }
